...
export const getAccountBalance = async (args: AccountAPTBalanceArguments): Promise<number> => {
    ...
    try {
      ...
      try {
        ...
        if (response && response.address) {
          ...
          // Get wallet balance
          const balance = await getAccountBalance({ accountAddress: response.address });
